...
import { Search, Star, Settings, Calculator, TrendingUp, Wifi, Car, Shield, Zap, Droplets } from "lucide-react"
...
const mockMatches: (Property & { match: PropertyMatch })[] = [
  {
    ...
    landlordContact: { phone: "+234 801 234 5678", email: "contact@adebayo.com" },
    status: "available",
  ...
  },
  {
    ...
    landlordContact: { phone: "+234 802 345 6789", email: "info@urbanliving.com" },
    status: "available",
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Linear programming optimization found {matches.length} properties that match your preferences
          </p>
        </div>
        ...
        <Tabs defaultValue="matches" className="space-y-6">
          ...
          <TabsContent value="matches" className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-bold text-purple-600">
                        {Math.round(matches.reduce((acc, m) => acc + m.match.matchScore, 0) / matches.length)}%
                      </p>
                    </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-semibold text-gray-900">Optimized Matches</h3>
                <Button variant="outline" size="sm" onClick={runOptimization} disabled={isOptimizing}>
                  {isOptimizing ? (
                    <>
          ...
          <TabsContent value="preferences" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Adjust your preferences to optimize the linear programming algorithm</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div>
                  <Label className="text-base font-medium">Budget Range (Annual)</Label>
                  <div className="mt-2">
                    <Slider
                      value={budget}
          ...
          <TabsContent value="optimization" className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">{optimizationStats.executionTime.toFixed(2)}s</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Constraints Satisfied</span>
                    <span className="font-semibold">{optimizationStats.constraintsSatisfied}/4</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Objective Value</span>
                    <span className="font-semibold">{optimizationStats.objectiveValue.toFixed(3)}</span>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <div className="flex justify-between mb-2">
                      <span className="text-sm text-gray-600">Budget Constraint</span>
                      <span className="text-sm font-medium text-green-600">Satisfied</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      <span className="text-sm text-gray-600">Amenity Requirements</span>
                      <span className="text-sm font-medium text-green-600">Satisfied</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      <span className="text-sm text-gray-600">Availability Constraint</span>
                      <span className="text-sm font-medium text-green-600">Satisfied</span>
                    </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Linear programming optimization model performance metrics</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 mb-4">Overall Optimization Score</p>
                  <p className="text-sm text-gray-500">
                    Based on weighted satisfaction of all constraints and objectives
                  </p>
                </div>
              </CardContent>
            </Card>
